...
- [ ] Task: Initialize Next.js Frontend with TypeScript, Tailwind, and Shadcn UI
- [ ] Task: Initialize Django Backend and Django Rest Framework
- [ ] Task: Configure Environment Variables and Shared Config
...
- [ ] Task: Write Tests for Custom User Model with Roles
- [ ] Task: Implement Custom User Model and Configure Limbo DB
- [ ] Task: Write Tests for User Registration Serializer
